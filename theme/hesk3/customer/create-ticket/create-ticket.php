                    ...
                    <form class="form form-submit-ticket ticket-create <?php echo count($_SESSION['iserror']) ? 'invalid' : ''; ?>" method="post" action="submit_ticket.php?submit=1" name="form1" id="form1" enctype="multipart/form-data">
                        <section class="form-groups">
                            ...
                            <div class="form-group">
                                ...
                                <input type="<?php echo $hesk_settings['multi_eml'] ? 'text' : 'email'; ?>" class="form-control <?php if (in_array('email', $_SESSION['iserror'])) {
                                                                                                                                    echo 'isError';
                        ...
                        <?php if ($hesk_settings['cust_urgency']) : ?>
                            <section class="param">
                                ...
                                <div class="dropdown-select center out-close priority">
                                    <select name="priority">
                                        ...
                                        <?php endif; ?>
                                        <option value="low" <?php if (isset($_SESSION['c_priority']) && $_SESSION['c_priority'] == 'low') {
                                                                echo 'selected';
                                                            } ?>>
                                            <?php echo $hesklang['low']; ?>
                                        </option>
                                        <option value="medium" <?php if (isset($_SESSION['c_priority']) && $_SESSION['c_priority'] == 'medium') {
                                                                    echo 'selected';
                                                                } ?>>
                                            <?php echo $hesklang['medium']; ?>
                                        </option>
                                        <option value="high" <?php if (isset($_SESSION['c_priority']) && $_SESSION['c_priority'] == 'high') {
                                                                    echo 'selected';
                                                                } ?>>
                            ...
                            <div class="form-group">
                                <select name="ticketzone" id="ticketzone" class="form-control">
                                    ...
                                    echo "<option disabled='true' value='0' selected>Cliente</option>";
                            ...
                            <div class="captcha-block">
                                ...
                                <?php if ($hesk_settings['question_use']) : ?>
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <input type="text" class="form-control <?php echo in_array('question', $_SESSION['iserror']) ? 'isError' : ''; ?>" name="question" size="20" value="<?php echo $value; ?>">
                                    </div>
                                <?php
                                endif;
